            ...
            >
              <div className="card-header">
                <div className="professional-avatar">
                  <img
                    src={professional.fotoPerfil ? `http://localhost:8080${professional.fotoPerfil}` : 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=120&h=120&fit=crop&crop=face'}
              ...
              <div className="card-footer">
                {/* COMENTADO: Botão de favoritar removido */}
                {/* <button 
