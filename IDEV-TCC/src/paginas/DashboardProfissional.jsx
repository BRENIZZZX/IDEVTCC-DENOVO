...
import CarouselEmpresas from '../componentes/CarouselEmpresas'
  ...
  useEffect(() => {
    const carregarDados = async () => {
      if (user) {
        ...
        try {
          const empresasResponse = await fetch('http://localhost:8080/api/v1/usuario/empresas')
    ...
    <PageTransition>
      ...
      <main className="dashboard-pro">
        <div className="dashboard-container">
            ...
            <>
              ...
              <div className="dashboard-grid professional">
                ...
                <div className="profile-summary-card">
                  ...
                  {/* COMENTADO: Botão "Enviar Request" removido */}
              ...
              {empresas.length > 0 && (
                <div style={{ marginTop: '3rem' }}>
                  <CarouselEmpresas empresas={empresas} />
                </div>
              )}
            </>
          )}

          {/* COMENTADO: Seção "Notificações" removida */}
          ...
          {/* COMENTADO: Seção "Agenda" removida */}
          {/* {secaoAtiva === 'agenda' && (
            <div className="section-content">
          ...
          {/* COMENTADO: Seção "Avaliações" removida */}
